...
const cV = { hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.2, delayChildren: 0.2 } } }
const iV = { hidden: { opacity: 0, scale: 0.95, y: 30 }, visible: { opacity: 1, scale: 1, y: 0, transition: { type: "spring", stiffness: 80, damping: 20 } } }
  ...
  return (
    <section id="vision" className="w-full py-24 relative z-10">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <motion.div variants={cV} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <motion.div variants={iV} className="glass-card rounded-3xl p-8 md:p-10 flex flex-col gap-6 border border-[#636CCB]/10 relative overflow-hidden group hover:border-[#6E8CFB]/25 hover:-translate-y-2 transition-all duration-500 shadow-lg hover:shadow-[0_0_30px_rgba(110,140,251,0.1)]">
          ...
          <motion.div variants={iV} className="glass-card rounded-3xl p-8 md:p-10 flex flex-col gap-6 border border-[#50589C]/15 relative overflow-hidden group hover:border-[#6E8CFB]/25 hover:-translate-y-2 transition-all duration-500 shadow-lg hover:shadow-[0_0_30px_rgba(110,140,251,0.1)]">
